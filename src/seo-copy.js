  ...
  "/tools/youtube-to-tiktok": {
    ...
    faqs: [
      ...
      { q: "What size should a TikTok video be?",
        a: "1080x1920, which is what DeenClipped renders. TikTok covers the bottom 484 pixels with its caption and music block and the right 140 with its button column, so keep captions clear of both — roughly the middle of the frame, and never the bottom quarter." },
    ],
  ...
  "/tools/youtube-to-reels": {
    ...
    sections: [
      { heading: "Reels eats the most vertical space, and captions pay for it",
        body: "Instagram puts the username, the caption and the controls along the bottom of a Reel and a row at the top. Meta unified the Stories and Reels safe areas in March 2026 and the unified figure is the strictest of any platform here — the bottom 670 pixels of a 1080x1920 frame, which is 35% of its height, plus the top 270. A caption line that sits comfortably on YouTube Shorts can be half-covered on Reels. The practical answer is to keep text in the middle third rather than near the bottom, which is where subtitles instinctively go; the free safe-zone checker on this site draws Instagram’s covered area over a frame of yours so you can see it rather than guess." },
    ...
    faqs: [
      ...
      { q: "Where should captions sit for Reels?",
        a: "The middle third, and higher than feels natural. Since Meta unified Stories and Reels in March 2026, Instagram covers the bottom 670 pixels of a 1080x1920 frame — 35% of its height — and the top 270, more than TikTok or Shorts, so a caption anywhere near the bottom is hidden. The safe-zone checker on this site shows the exact area over your own frame." },
  ...
  "/guides/long-video-to-shorts": {
    ...
    faqs: [
      ...
      { q: "Do I need to re-edit for each platform?",
        a: "Not if you keep captions inside a conservative safe zone. The platforms cover different parts of the frame with their own interface, so text that clears the worst case on each edge survives on all of them. See the safe zones guide for where those edges are." },
  ...
  "/guides/caption-safe-zones": {
    ...
    sections: [
      { heading: "The one rule, if you read nothing else",
        body: "Keep caption text inside a rectangle of roughly 865 x 980 pixels within the 1080 x 1920 frame, sitting 270 pixels down from the top and 65 in from the left. It is NOT centred, and that is the part everyone gets wrong: the button column on the right is wider than the left margin, and the bottom band is more than twice the top. Clear that rectangle and one export works everywhere, with no re-editing per platform. Everything below is why it is where it is. Checked September 2026 — platforms move their interface without announcing it, so treat these as working rules rather than a specification." },
      { heading: "Where each platform covers the frame",
        body: "Instagram and Facebook Reels are now the tightest, and they are one number: Meta unified the Stories and Reels safe areas in March 2026, reserving the top 270px and the bottom 670px — 35% of the height, because the bottom stacks the caption, likes, comments, share, save, audio and the call to action. TikTok reserves 130px at the top, 484px at the bottom and 140px down the right for its button column. YouTube Shorts is the mildest, but its trap is the description: the bottom overlay grows to about 400px once a viewer taps to expand it, so design for the expanded state rather than the collapsed one. Taking the worst case on each edge separately — no single platform is strictest on all four — is what produces the rectangle above." },
    ...
    faqs: [
      { q: "What is the safe zone for vertical video?",
        a: "As a single working rule: an 865 x 980 rectangle inside a 1080 x 1920 frame, 270 pixels down from the top and 65 in from the left. It is not centred — the right-hand button column is wider than the left margin and the bottom band is deeper than the top. That clears TikTok’s button column and caption block, Meta’s unified Reels area on Instagram and Facebook, and YouTube Shorts’ controls, so the same export works everywhere without re-editing." },
      ...
      { q: "Do safe zones change?",
        a: "Yes, and without announcement. TikTok added a button at the bottom-right in January 2026 and YouTube expanded its subscribe area in late 2025, each pushing an edge inward. This is why the conservative rectangle above is worth using rather than measuring each edge to the pixel: it has margin for the next change built into it." },
    ],
  ...
  "/tools/safe-zone-checker": {
    ...
    faqs: [
      { q: "What is the safe zone for TikTok, Reels and Shorts?",
        a: "A rectangle of about 865 x 980 pixels inside a 1080 x 1920 frame, 270 down from the top and 65 in from the left, clears all of them. Individually, Meta’s unified Reels area on Instagram and Facebook takes the most vertical space, TikTok is tightest on the right edge, and YouTube Shorts covers the least — though its bottom overlay grows when a viewer expands the description." },
