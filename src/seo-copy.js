...
export const SEO_COPY = {
  ...
  "/tools/youtube-to-shorts": {
    ...
    sections: [
      ...
      { heading: "The one thing you should know before connecting: uploads currently arrive private",
        body: "DeenClipped uploads to YouTube ask for public, and the code names `privacyStatus: public` explicitly. But Google restricts uploads from any API project that has not passed its compliance audit to private, whatever the request says — and ours has not passed yet. So today, a clip published to YouTube through DeenClipped lands on your channel as a private video that you flip to public yourself. That is one extra click per clip, it is temporary, and it is the sort of thing you would rather read here than discover after paying." },
    ...
    faqs: [
      ...
      { q: "Why did my clip upload as private?",
        a: "Google restricts uploads from API projects that have not completed its compliance audit to private, regardless of what the upload requests. DeenClipped asks for public and Google overrides it. Until that audit closes, switch the video to public in YouTube Studio after it arrives." },
