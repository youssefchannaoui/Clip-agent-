...
function pricingCards(currentUser = null) {
  ...
  const plans = [
    ...
    { id: 'monthly', kicker: 'Consistent', name: 'Monthly', price: config.planPriceMonthlyLabel, listPrice: config.planPriceMonthlyListLabel, tokens: config.tokensMonthly, interval: 'tokens/month', copy: 'For creators building a dependable short-form schedule.', enabled: Boolean(config.stripePriceMonthly), popular: true, features: ['Everything in Weekly', 'Creator Lab content intelligence', 'Batch scheduling and publishing'] },
  ...
  const body = `<main>
    ...
    <section class="page-content"><div class="wrap">
      <div class="feature-page-grid">
        ...
        <article>${icon('spark')}<h3>Creator Lab</h3><p>See your strongest hooks, topic coverage, content gaps and a ranked weekly publishing lineup.</p></article>
