...
function sourceForm() {
  return `<form class="source-bar" data-source-form><span class="source-icon">${icon('link')}</span><label class="sr-only" for="source-url">Video URL</label><input id="source-url" name="source" placeholder="Paste a link to a video on your channel" autocomplete="off"><button type="submit">Start with this video ${icon('arrow')}</button></form>`;
}
          ...
          <div class="journey-main">
            ...
            <div class="journey-stages">
              ...
              <div class="journey-stage" style="--i:0">
                ...
                <p>A link to a video on your own YouTube channel, or an MP4/MOV you have the rights to. Nothing else is asked for yet.</p>
...
export function terms({ base, currentUser }) {
  const body = `<main><section class="page-hero wrap"><span class="eyebrow"><i></i>Legal</span><h1>Terms of Service</h1><p>The rules for using DeenClipped to create, review and publish short-form clips.</p></section><section class="page-content"><article class="legal"><p>Last updated: 7 September 2026</p><p>These Terms govern use of DeenClipped, a service for creating, reviewing and publishing short-form clips from long videos.</p><h2>Use of the service</h2><p>You must use DeenClipped lawfully and only with content you own or have permission to use. You are responsible for the videos, links, clips, captions and posts you create or publish through the service.</p><p>Importing by <strong>YouTube link is limited to videos on a YouTube channel you have connected to DeenClipped</strong>. When you paste a link, DeenClipped reads the owning channel through the YouTube Data API and refuses the import unless that channel is one you have connected and authorised through Google sign-in. DeenClipped does not download videos from channels you do not control. For any other source material — including content you have permission to clip but did not publish yourself — upload the file instead.</p><h2>Source content and copyright</h2><p>Uploading videos you do not own or do not have permission to use may violate copyright or platform rules. By using DeenClipped, you confirm that you have the required rights and permissions. For YouTube links this is enforced rather than assumed: the video must be on a channel you have connected, so a link to third-party content cannot be imported at all.</p><h2>Google and YouTube services</h2><p>DeenClipped uses YouTube API Services for connected-channel and publishing features. By using those features, you also agree to the <a href="https://www.youtube.com/t/terms" target="_blank" rel="noopener">YouTube Terms of Service</a> and acknowledge the <a href="https://policies.google.com/privacy" target="_blank" rel="noopener">Google Privacy Policy</a>. DeenClipped publishes only through the permissions you grant and the actions you approve or schedule. You can remove DeenClipped's access from the Connections screen in the app or from your Google Account connections.</p><h2>Connected platforms</h2><p>DeenClipped can publish to Facebook Pages, Instagram professional accounts and TikTok once you connect them. Publishing happens only through the permissions you grant and the posts you approve or schedule, and each post carries the privacy and interaction settings you chose for it. Using those features also means agreeing to the <a href="https://www.facebook.com/terms.php" target="_blank" rel="noopener">Meta Terms of Service</a>, the <a href="https://help.instagram.com/581066165581870" target="_blank" rel="noopener">Instagram Terms of Use</a> and the <a href="https://www.tiktok.com/legal/page/row/terms-of-service/en" target="_blank" rel="noopener">TikTok Terms of Service</a>, and to each platform’s own content rules. You remain responsible for what you publish. You can disconnect any platform from the Connections screen in the app at any time.</p><h2>Billing and tokens</h2><p>Some features require tokens, subscriptions or paid plans. Token usage is based on the selected source-video time and the plan rules displayed in the app. Checkout displays final billing terms before purchase.</p><h2>Service availability</h2><p>Features may change, pause or be removed over time. DeenClipped does not guarantee uninterrupted access or that every video URL can be imported. YouTube link import covers only videos on channels you have connected, is not an official YouTube Data API download capability, and remains subject to source availability and platform restrictions. Where a link cannot be retrieved, the file can be downloaded from YouTube Studio and uploaded instead.</p><h2>Contact</h2><p>Questions can be sent to <a href="mailto:support@deenclipped.online">support@deenclipped.online</a>.</p></article></section></main>`;
  const disclosedBody = body
    .replace('<h2>Billing and tokens</h2>', '<h2>YouTube URL processing</h2><p>When you submit a YouTube link, DeenClipped first confirms through the YouTube Data API that the video belongs to a channel you have connected, and refuses the import otherwise. Only then is the selected stretch of the video retrieved for clipping. This retrieval is separate from the official YouTube API connection used for channel identity and publishing, and may fail because of source restrictions, rights controls, availability, quotas or platform changes; the file can be downloaded from YouTube Studio and uploaded instead.</p><h2>Billing and tokens</h2>')
