...
export function privacy({ base, currentUser }) {
  ...
  const compliantBody = body
    .replace(/<p>When you paste a link to a video for clipping,[\s\S]*?<\/p>/, '<p>DeenClipped does not use the YouTube API to access anyone else\'s videos or import audiovisual source files from public URLs.</p>')
