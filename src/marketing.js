  ...
  <footer class="site-footer">
    <div class="wrap">
      <div class="footer-grid">
        ...
        <div class="footer-col"><h4>Company</h4><a href="/about">About</a><a href="/affiliates">Affiliate programme</a><a href="/contact">Contact</a><a href="/privacy">Privacy Policy</a><a href="/terms">Terms of Service</a></div>
...
export const FAQ_ITEMS = [
  ...
  { q: 'Is the clip editor available now?',
    a: 'Yes, on a laptop-width screen. It trims a clip, cuts sections out of the middle, edits caption words and repositions captions, and every change is rendered into the clip on Save. It is not a frame-level editor: there are no overlays, extra media or keyframes.' },
  { q: 'What is DeenAI?',
...
export function features({ base, currentUser }) {
  const body = `<main>
    ...
    <section class="page-content"><div class="wrap">
      ...
      <section class="feature-deep-dive reveal" id="editor"><div class="feature-deep-copy"><span class="section-label">Templates, audio and editor preview</span><h2>Trim, cut and retime on a real timeline. The frame-level editor is still a concept.</h2><p>Open any clip from the queue: drag the handles to trim it, cut a section out of the middle, edit the caption words and drag the captions where you want them. Save renders the cut into the clip with the captions retimed word by word. Overlays, extra media and keyframes are not built — the preview below is a concept, and is labelled as one.</p><div class="detail-list">${checkItem('Clip-local or reusable','Keep one clip’s adjustment local, or save the look back to the shared template for future waiting clips.')}${checkItem('One timeline origin','The editor plays the rendered clip itself — the same file the review queue plays — so what you see is what ships, never a drawn imitation.')}${checkItem('Vocal-only track control','Upload, select and rotate nasheed tracks while respecting the Quran template’s music-off rule.')}</div></div><div class="editor-feature-visual"><div class="product-frame"><img src="/marketing-assets/editor-premium.webp" alt="Concept preview of frame-level tools that are not yet built" loading="lazy"></div><span class="availability-badge">Concept preview · frame-level tools coming soon</span></div></section>
  ...
  const body = `<main>
    ...
    <section class="page-content"><div class="wrap">
      ...
      <article class="legal" id="terms">
        ...
        <ul>
          <li>Subscription payments earn commission. One-off token top-ups do not: they are a purchase, not recurring revenue you introduced.</li>
          <li>Commission is calculated on what the customer actually paid, after any discount they used.</li>
          <li>Commission is held in the currency the customer paid in. We do not convert between currencies, and a balance is paid in the currency it was earned in.</li>
          <li>Nothing is earned on payments made before your application was approved.</li>
        </ul>
        <h2>Getting paid</h2>
        <p>Each commission is held for <strong>${hold} days</strong> from the payment, so the refund window closes first. After that it is payable. If the payment behind it is refunded or disputed inside that window, the commission is void — which is the whole reason the hold exists rather than paying you and asking for it back.</p>
        <p>Payouts are made by hand, by PayPal, Wise or bank transfer, to the account you gave us when you applied. We aim to pay once a balance clears <strong>A$${floor}</strong> in a single currency, and you can ask about a smaller balance at any time — the floor is there so a transfer does not cost more in fees than it moves, not to hold on to your money.</p>
        <p>You are responsible for any tax on what you earn. We do not withhold tax, and outside Australia we generally cannot. If you are registered for GST in Australia, tell us and we will handle the invoice correctly.</p>
        <h2>What is not allowed</h2>
        <ul>
          <li><strong>Referring yourself.</strong> You cannot earn commission on your own account, your family's, or a business you control. This is the one rule we enforce automatically and the one that ends a partnership.</li>
          <li><strong>Bidding on our name.</strong> No paid search or shopping ads on "DeenClipped" or misspellings of it, and no ads that read as if they come from us.</li>
          <li><strong>Coupon and deal sites.</strong> We do not issue affiliate discount codes, and listing invented, leaked or expired codes is grounds for removal.</li>
          <li><strong>Claiming things we do not do.</strong> Do not promise view counts, growth figures, or features the product does not have. No platform sends us audience numbers, so nobody can honestly quote them. If you are not sure whether something is true, ask us.</li>
          <li><strong>Anything that misrepresents the deen.</strong> This product exists to help lectures and recitation reach people. Promotion that would embarrass a scholar whose words we clip is not promotion we want.</li>
        </ul>
        <h2>Changes, and what happens to what you have already earned</h2>
        <p>The rate you were approved at is the rate you are paid at. If we change the programme's terms, the change applies to new applications; your own rate does not move because ours did.</p>
        <p>Either of us can end the arrangement at any time. If we end it, commission already earned and past its hold is still paid. If it ends because of something in the list above, it is not.</p>
        <h2>Questions</h2>
        <p>Email <a href="mailto:support@deenclipped.online?subject=DeenClipped%20affiliate%20programme">support@deenclipped.online</a>.</p>
      </article>
    </div></section></main>`;
  return layout({ base, currentUser, ...meta('/affiliates'), body,
    jsonLd: [organizationSchema(base), webSiteSchema(base)] });
}

function legacyTerms({ base, currentUser }) {
  const body = `<main><section class="page-hero wrap"><span class="eyebrow"><i></i>Legal</span><h1>Terms of Service</h1><p>The rules for using DeenClipped to create, review and publish short-form clips.</p></section><section class="page-content"><article class="legal"><p>Last updated: 9 September 2026</p><p>These Terms govern use of DeenClipped, a service for creating, reviewing and publishing short-form clips from long videos.</p><h2>Use of the service</h2><p>You must use DeenClipped lawfully and only with content you own or have permission to use. You are responsible for the videos, links, clips, captions and posts you create or publish through the service.</p><h2>Source content and copyright</h2><p>Uploading or importing videos you do not own or do not have permission to use may violate copyright or platform rules. By using DeenClipped, you confirm that you have the required rights and permissions.</p><h2>Google and YouTube services</h2><p>DeenClipped uses YouTube API Services for two things only: identifying the YouTube channel you connect, and uploading your finished clips to that channel. It does not use the YouTube API to search, browse or retrieve information about videos on any other channel. By using those features, you also agree to the <a href="https://www.youtube.com/t/terms" target="_blank" rel="noopener">YouTube Terms of Service</a> and acknowledge the <a href="https://policies.google.com/privacy" target="_blank" rel="noopener">Google Privacy Policy</a>. DeenClipped publishes only through the permissions you grant and the actions you approve or schedule. You can remove DeenClipped's access from the Connections screen in the app or from your Google Account connections.</p><h2>Connected platforms</h2><p>DeenClipped can publish to Facebook Pages, Instagram professional accounts and TikTok once you connect them. Publishing happens only through the permissions you grant and the posts you approve or schedule, and each post carries the privacy and interaction settings you chose for it. Using those features also means agreeing to the <a href="https://www.facebook.com/terms.php" target="_blank" rel="noopener">Meta Terms of Service</a>, the <a href="https://help.instagram.com/581066165581870" target="_blank" rel="noopener">Instagram Terms of Use</a> and the <a href="https://www.tiktok.com/legal/page/row/terms-of-service/en" target="_blank" rel="noopener">TikTok Terms of Service</a>, and to each platform’s own content rules. You remain responsible for what you publish. You can disconnect any platform from the Connections screen in the app at any time.</p><h2>Billing and tokens</h2><p>Some features require tokens, subscriptions or paid plans. Token usage is based on the selected source-video time and the plan rules displayed in the app. Checkout displays final billing terms before purchase.</p><h2>Service availability</h2><p>Features may change, pause or be removed over time. DeenClipped does not guarantee uninterrupted access or that every external video URL can be imported. Importing from a video URL does not use a YouTube API and is not an official YouTube download capability; it remains subject to source availability, provider access and platform restrictions.</p><h2>Contact</h2><p>Questions can be sent to <a href="mailto:support@deenclipped.online">support@deenclipped.online</a>.</p></article></section></main>`;
  const disclosedBody = body
...
/*
 * Current policy copy. The earlier direct-platform wording is intentionally
 * retained above only as release history; these are the functions routed by
 * the live site. It must describe the product that is actually shipped, not
 * an OAuth integration that no longer has a reachable route.
 */
export function privacy({ base, currentUser }) {
  const body = `<main><section class="page-hero wrap"><span class="eyebrow"><i></i>Legal</span><h1>Privacy Policy</h1><p>How DeenClipped handles account, source and publishing information.</p></section><section class="page-content"><article class="legal"><p>Last updated: 11 September 2026</p><p>DeenClipped helps users create, review and publish short-form clips from long videos. This policy explains what we collect and why.</p><h2>Account and workspace data</h2><p>We store the account information you provide, hashed password credentials where you use email sign-in, project settings, submitted source details, generated clips, captions, templates, schedules and publishing preferences. We use this only to operate your workspace and provide support.</p><h2>Source links and uploads</h2><p>You are responsible for submitting only videos you own or are authorised to use. A public video URL or file you submit is processed by DeenClipped to create the clips you request. URL availability can change and an import may be unavailable because of source, rights, provider or platform restrictions.</p><h2>Connected publishing accounts</h2><p>YouTube, Instagram and Facebook connections are made through Buffer. DeenClipped receives a Buffer authorisation token and channel details needed to send only the clips you approve or schedule. The Buffer token is encrypted at rest and is separated by DeenClipped account. DeenClipped does not receive or store a Google OAuth token for a YouTube channel through this flow.</p><p>DeenClipped does not use Google APIs to import source videos, search YouTube, read watch history, view analytics, comments, subscribers or direct messages. A Buffer connection can be removed from the Connections screen; this disables future Buffer publishing from DeenClipped. You can also manage the connected account in Buffer.</p><h2>TikTok</h2><p>If you connect TikTok directly, DeenClipped stores the encrypted token and account identifier needed to publish clips you explicitly approve or schedule. It does not request or store your follower list, comments or direct messages.</p><h2>Security, retention and deletion</h2><p>Credentials are encrypted at rest and access is limited to operating the connected publishing service. You can delete your account from Account settings. This removes your account, workspace records, sessions and credentials held by DeenClipped. Published posts remain under your control on the third-party platform.</p><h2>Contact</h2><p>For privacy or data-control questions, email <a href="mailto:support@deenclipped.online">support@deenclipped.online</a>.</p></article></section></main>`;
  return layout({ base, currentUser, ...meta('/privacy'), body });
}

export function terms({ base, currentUser }) {
  const body = `<main><section class="page-hero wrap"><span class="eyebrow"><i></i>Legal</span><h1>Terms of Service</h1><p>The rules for creating, reviewing and publishing clips with DeenClipped.</p></section><section class="page-content"><article class="legal"><p>Last updated: 11 September 2026</p><p>These Terms govern use of DeenClipped, a service for creating, reviewing and publishing short-form clips from long videos.</p><h2>Your source content</h2><p>You must use DeenClipped only with content you own or have permission to use. You are responsible for the videos, links, clips, captions and posts you create or publish. URL imports are not an official YouTube download capability and may be unavailable because of source availability, permissions, provider access or platform restrictions.</p><h2>Connected platforms</h2><p>YouTube, Instagram and Facebook publishing is connected through Buffer. TikTok may be connected directly where that platform makes the feature available. Publishing happens only after you approve or schedule it. You remain responsible for complying with each connected platform’s terms and content rules.</p><h2>Billing and availability</h2><p>Some features use tokens, subscriptions or paid plans. Checkout displays the applicable billing terms before payment. Features may change, pause or be removed; DeenClipped does not guarantee uninterrupted access to an external source or platform.</p><h2>Contact</h2><p>Questions can be sent to <a href="mailto:support@deenclipped.online">support@deenclipped.online</a>.</p></article></section></main>`;
  return layout({ base, currentUser, ...meta('/terms'), body });
}
...
export function llmsTxt({ base }) {
  ...
  return [
    ...
    'the clip editor trims and cuts but has no frame-level tools, overlays or',
    'extra media;',
