...
/**
 * The sign-in page shows a stylised placeholder, never real clips.
 *
 * It used to render the newest thumbnails and titles from `state.clips` —
 * whoever they belonged to — on a page that requires no authentication. Any
 * visitor could watch customers' lecture titles and frames appear there. The
 * page is public, so it gets no customer data at all.
 */
