...
/* Final polish: keep compact density without sacrificing alignment or legibility. */
body.dc-app button,body.dc-app [role="button"]{line-height:1.2}
body.dc-app .dc-btn,.dc-premium-nav-button,.dc-premium-site-link,.dc-topup-card button,.dc-wallet-bonus{justify-content:center;text-align:center}
.dc-premium-nav-button,.dc-premium-site-link{justify-content:flex-start}
.dc-wallet-bonus{font-size:10px;font-weight:750;line-height:1;padding:5px 9px}
.dc-topup-shop{padding:22px 24px;border-radius:19px;background:radial-gradient(circle at 0 0,rgba(217,180,120,.10),transparent 38%),rgba(255,255,255,.018)}
.dc-topup-head{align-items:center;margin-bottom:16px}.dc-topup-head p{font-size:11px;line-height:1.5}.dc-topup-head span{font-size:10px;font-weight:700}
.dc-topup-grid{gap:12px}.dc-topup-card{padding:16px;border-radius:14px}.dc-topup-card .label{align-items:center;font-size:10px}.dc-topup-card strong{font-size:28px;margin-top:12px}.dc-topup-card small{font-size:10px;line-height:1.45}.dc-topup-card button{min-height:40px;font-size:11px;line-height:1.2}
.dc-admin-head p{font-size:12px;line-height:1.6}.dc-admin-metric span,.dc-admin-metric small,.dc-admin-social span,.dc-admin-event{font-size:10px}.dc-admin-event>strong{font-size:11px}.dc-plan-row{font-size:10px}.dc-usage-day small{font-size:8px}.dc-admin-table th{font-size:9px}.dc-admin-table td{font-size:10px}.dc-admin-user b{font-size:10.5px}.dc-admin-user span,.dc-admin-role{font-size:9px}
