...
const GUIDE_STEPS = [
  ...
  {view:'publishing',target:'#view-publishing',title:'Platforms connect accounts',copy:'TikTok, YouTube, Instagram and Facebook connections belong here. After login is added, every user will connect their own accounts safely.'},
  ...
  {view:'automation',target:'#view-automation',title:'Studio Settings',copy:'Generation defaults, automation rules, posting controls and YouTube downloader cookies live here.'},
  ...
  {view:'home',target:'#dcNewProject',title:'Next phase: login and accounts',copy:'The next real build should add sign up/login, separate user data, Stripe billing, and per-user platform connections before going public.'}
];
let guideIndex = 0;
