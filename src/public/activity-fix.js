...
.dc-v5-now{min-height:76px;display:grid;grid-template-columns:42px minmax(0,1fr) auto;gap:13px;align-items:center;padding:13px 16px;border:1px solid rgba(221,183,118,.17);border-radius:18px;background:linear-gradient(90deg,rgba(221,183,118,.075),rgba(255,255,255,.018) 48%,rgba(52,112,151,.045));box-shadow:0 14px 40px rgba(0,0,0,.16)}.dc-v5-now-icon{width:42px;height:42px;display:grid;place-items:center;border-radius:13px;background:rgba(221,183,118,.11);color:#d8b875}.dc-v5-now-icon.live{background:rgba(109,211,154,.1);color:#6dd39a}.dc-v5-now-icon svg{width:20px;height:20px;fill:none!important;stroke:currentColor!important;stroke-width:1.8!important;stroke-linecap:round;stroke-linejoin:round}.dc-v5-now-copy{min-width:0}.dc-v5-now-copy small,.dc-v5-now-copy strong,.dc-v5-now-copy span{display:block}.dc-v5-now-copy small{margin-bottom:3px;color:#c6a86d;font-size:7.5px;font-weight:850;letter-spacing:.13em;text-transform:uppercase}.dc-v5-now-copy strong{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-size:12px}.dc-v5-now-copy span{margin-top:3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:#7f7f88;font-size:8.5px}.dc-v5-now .dc-btn{min-height:36px;border-radius:11px}.dc-v5-now-progress{height:3px;margin-top:7px;overflow:hidden;border-radius:999px;background:rgba(255,255,255,.07)}.dc-v5-now-progress i{display:block;height:100%;border-radius:999px;background:linear-gradient(90deg,#d5af68,#f2d69b)}
...
function renderHome(){
  ...
  panel.innerHTML = `
    <div class="dc-home-v5">
      ...
      ${v5HappeningNow(jobs,next,waiting,selectedTemplate)}
...
function v5HappeningNow(jobs,next,waiting,templateName){
