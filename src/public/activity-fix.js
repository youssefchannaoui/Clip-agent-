...
function templateFontFamily(value){
  const fonts={'Manrope':'Manrope, sans-serif','Roboto':'Roboto, sans-serif','Lato':'Lato, sans-serif','Noto Sans':'Noto Sans, sans-serif','Noto Serif':'Noto Serif, serif','Cantarell':'Cantarell, sans-serif','Play':'Play, sans-serif','Andika':'Andika, sans-serif','Liberation Sans':'Liberation Sans, sans-serif','Liberation Serif':'Liberation Serif, serif','DejaVu Sans':'DejaVu Sans, sans-serif','DejaVu Serif':'DejaVu Serif, serif','Amiri':'Amiri, serif','Scheherazade New':'Scheherazade New, serif','Noto Naskh Arabic':'Noto Naskh Arabic, serif','Noto Kufi Arabic':'Noto Kufi Arabic, sans-serif'};
