...
const CUSTOM = new Set(['home','projects','review','editor','insights','publishing','music','automation']);
...
/* V3 polish pass: less writing, nicer projects, full custom utility pages */
.dc-v3-hero-compact{grid-template-columns:minmax(0,1fr) minmax(250px,.62fr);padding:20px;margin-bottom:10px}.dc-v3-hero-compact .dc-v3-title{font-size:32px;max-width:700px}.dc-v3-hero-compact .dc-v3-copy{font-size:12px;max-width:560px}.dc-v3-hero-compact .dc-v3-phone-wall{min-height:205px}.dc-v3-hero-compact .dc-v3-phone{width:92px;border-radius:15px}.dc-v3-action-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin:12px 0}.dc-home-metrics-tight{grid-template-columns:repeat(5,minmax(0,1fr));gap:10px}.dc-home-grid-balanced{grid-template-columns:minmax(0,1.08fr) minmax(360px,.92fr)}.dc-short-list .dc-list-row,.dc-now-compact .dc-now-row{min-height:48px;padding:9px 10px}.dc-now-compact .dc-now-main strong,.dc-short-list .dc-list-copy strong{font-size:10px}.dc-now-compact .dc-card-head p,.dc-short-list .dc-list-copy span{font-size:8px}.dc-project-card.v3-project{position:relative;min-height:0}.dc-project-card.v3-project .dc-project-cover{height:180px;border:0;border-bottom:1px solid var(--dc-line);width:100%;display:block;text-align:left}.dc-project-placeholder{height:100%;display:flex;flex-direction:column;align-items:flex-start;justify-content:flex-end;gap:8px;padding:16px;background:radial-gradient(circle at 82% 10%,rgba(217,180,120,.12),transparent 35%),linear-gradient(180deg,#18181c,#0d0d10);color:var(--dc-muted)}.dc-project-placeholder svg{width:34px;height:34px;fill:none;stroke:currentColor;stroke-width:1.6}.dc-project-placeholder span{font-size:11px;color:var(--dc-subtle)}.dc-project-delete{position:absolute!important;top:9px;left:9px;z-index:4;width:32px!important;height:32px!important;background:#0b0b0dcc!important;color:#fff!important}.dc-project-body h3{font-size:14px;line-height:1.25;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;white-space:normal}.dc-project-body p{display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;min-height:25px}.dc-project-stats{display:grid;grid-template-columns:repeat(4,1fr);gap:7px}.dc-project-stat{padding:8px;border:1px solid var(--dc-line);border-radius:8px;background:#09090b}.dc-project-actions{grid-template-columns:1fr 1fr auto}.dc-project-actions .dc-btn.danger{padding:0 9px}.dc-project-detail-view{max-width:calc(100vw - var(--dc-side) - 64px)!important;overflow:hidden}.dc-project-detail-v3{width:100%;overflow:hidden}.dc-project-detail-hero{display:flex;align-items:center;gap:10px;margin-bottom:12px;padding:12px;border:1px solid var(--dc-line);border-radius:16px;background:linear-gradient(135deg,rgba(217,180,120,.08),#101013)}.dc-project-detail-hero .dc-project-detail-copy{flex:1;min-width:0}.dc-project-detail-hero h1{font-size:18px;line-height:1.2;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.dc-project-detail-hero p{font-size:10px}.dc-project-error{display:flex;align-items:center;gap:10px;margin-bottom:12px;padding:10px 12px;border:1px solid rgba(239,107,122,.25);border-radius:12px;background:rgba(239,107,122,.06);color:var(--dc-red);font-size:10px}.dc-project-error span{flex:1;line-height:1.35}.dc-project-detail-toolbar{display:flex;align-items:center;gap:8px;margin:10px 0}.dc-project-detail-toolbar .spacer{flex:1}.dc-project-clip-grid{grid-template-columns:repeat(auto-fit,minmax(218px,260px));justify-content:start;align-items:start;max-width:100%;overflow:hidden}.dc-project-clip-grid .dc-clip-card{max-width:260px}.v3-clip-card .dc-clip-media{border:0;width:100%}.dc-clip-state{position:absolute;left:9px;top:9px}.v3-clip-card .dc-clip-actions{grid-template-columns:1fr 1fr;gap:7px}.v3-clip-card .dc-clip-actions .dc-btn{min-height:34px}.dc-review-queue{display:flex;flex-direction:column;gap:10px}.dc-review-row{display:grid;grid-template-columns:78px minmax(0,1fr) auto;gap:12px;align-items:center;padding:10px;border:1px solid var(--dc-line);border-radius:14px;background:linear-gradient(180deg,#141416,#0c0c0e)}.dc-review-thumb{position:relative;width:78px;aspect-ratio:9/16;border-radius:9px;overflow:hidden;background:#000;color:#fff}.dc-review-thumb img{width:100%;height:100%;object-fit:cover}.dc-review-thumb span{position:absolute;left:6px;bottom:6px;padding:3px 6px;border-radius:999px;background:#0a0a0dcc;color:#b9ff69;font-size:10px;font-weight:800}.dc-review-main strong,.dc-review-main small{display:block}.dc-review-main strong{font-size:13px}.dc-review-main small{font-size:9px;color:var(--dc-muted);margin-top:4px}.dc-review-actions{display:flex;gap:7px;flex-wrap:wrap;justify-content:flex-end}.dc-review-actions .dc-btn{min-height:34px;font-size:9.5px}.dc-analytics-hero,.dc-audio-hero{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:10px;margin-bottom:14px}.dc-analytics-stat,.dc-audio-hero>div{padding:17px;border:1px solid var(--dc-line);border-radius:16px;background:linear-gradient(180deg,#151518,#0d0d0f)}.dc-analytics-stat strong,.dc-audio-hero strong{display:block;font-size:30px;line-height:1}.dc-analytics-stat span,.dc-audio-hero span{display:block;margin-top:7px;font-size:10px;color:var(--dc-muted)}.dc-analytics-stat.bad strong{color:var(--dc-red)}.dc-funnel{display:grid;grid-template-columns:repeat(2,1fr);gap:9px}.dc-funnel div{padding:14px;border:1px solid var(--dc-line);border-radius:12px;background:#0b0b0d}.dc-funnel b{display:block;font-size:24px}.dc-funnel span{font-size:9px;color:var(--dc-muted)}.dc-connection-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:12px;margin-bottom:14px}.dc-connection-card{padding:15px;border:1px solid var(--dc-line);border-radius:18px;background:linear-gradient(180deg,#151519,#0b0b0d);position:relative;overflow:hidden}.dc-connection-card::after{content:'';position:absolute;right:-30px;bottom:-30px;width:110px;height:110px;border-radius:50%;background:rgba(255,255,255,.035)}.dc-connection-top{display:flex;align-items:center;gap:11px;position:relative;z-index:1}.dc-connection-top div:nth-child(2){flex:1}.dc-connection-top strong,.dc-connection-top span{display:block}.dc-connection-top strong{font-size:14px}.dc-connection-top span{font-size:10px;color:var(--dc-muted);margin-top:2px}.dc-connection-logo{width:44px;height:44px;border-radius:15px;display:grid;place-items:center}.dc-connection-logo svg{width:24px;height:24px}.dc-connection-logo.youtube{background:rgba(255,0,51,.13);color:#ff4f72}.dc-connection-logo.tiktok{background:rgba(37,244,238,.11);color:#25f4ee}.dc-connection-logo.instagram{background:rgba(233,90,154,.13);color:#ff89bd}.dc-connection-logo.facebook{background:rgba(91,140,255,.13);color:#8ea9ff}.dc-connection-actions{display:flex;gap:8px;margin-top:18px;position:relative;z-index:1}.dc-connection-actions .dc-btn{flex:1}.dc-settings-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:14px}.dc-field input[type=range]{width:100%}@media(max-width:980px){.dc-v3-action-grid,.dc-home-metrics-tight{grid-template-columns:repeat(2,minmax(0,1fr))}.dc-home-grid-balanced{grid-template-columns:1fr}.dc-project-detail-view{max-width:100%!important}.dc-review-row{grid-template-columns:64px 1fr}.dc-review-actions{grid-column:1/-1;justify-content:flex-start}.dc-project-clip-grid{grid-template-columns:repeat(auto-fit,minmax(190px,1fr))}}@media(max-width:720px){.dc-v3-hero-compact{grid-template-columns:1fr}.dc-v3-action-grid{grid-template-columns:1fr}.dc-home-metrics-tight{grid-template-columns:repeat(2,1fr)}.dc-project-stats{grid-template-columns:repeat(2,1fr)}.dc-project-actions{grid-template-columns:1fr}.dc-project-detail-hero{flex-wrap:wrap}.dc-project-detail-hero h1{white-space:normal}.dc-project-clip-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
...
function injectShell(){
  ...
  style.id = 'dcPhase4Styles'; style.textContent = css + v3Css; document.head.appendChild(style);
...
function handleClick(event){
  ...
  const editStyle = event.target.closest('[data-edit-style-clip]'); if (editStyle) { editor.tool='style'; openEditor(editStyle.dataset.editStyleClip); return; }
  const editVideo = event.target.closest('[data-edit-video-clip]'); if (editVideo) { editor.tool='canvas'; openEditor(editVideo.dataset.editVideoClip); return; }
  const edit = event.target.closest('[data-edit-clip]'); if (edit) { openEditor(edit.dataset.editClip); return; }
  ...
  const deleteTrack = event.target.closest('[data-delete-track]'); if (deleteTrack) { deleteMusicTrack(deleteTrack.dataset.deleteTrack); return; }
  const saveMusic = event.target.closest('#dcV3SaveMusic'); if (saveMusic) { saveMusicSettingsV3(); return; }
  const saveSettings = event.target.closest('#dcV3SaveSettings'); if (saveSettings) { saveAutomationSettingsV3(); return; }
...
function go(view){
  ...
  const labels = {
    ...
    review:['Clip Review','Approve, edit or schedule clips'], editor:['Editor','Edit the selected clip'],
    schedule:['Publish','Scheduling and platform delivery'], insights:['Analytics','Performance overview'],
    publishing:['Connections','Platform accounts and posting'], music:['Audio library','Nasheed tracks and volume'],
    automation:['Settings','App, render and posting controls']
  };
  ...
  if (CUSTOM.has(view)) {
    ...
    if (view === 'automation') renderSettings();
...
function renderHome(){
  ...
  const selectedTemplate = d.selectedTemplate?.name || 'No template selected';
  panel.innerHTML = `<section class="dc-v3-hero dc-v3-hero-compact" data-tour="home-hero"><div><div class="dc-v3-kicker">${ICON.scissors} V3 workspace</div><h1 class="dc-v3-title">Create clean dawah clips, review them fast, then post.</h1><p class="dc-v3-copy">One flow: import, generate, approve, edit, publish. Less reading — more visual progress.</p><div class="dc-v3-actions"><button class="dc-btn" id="dcHeroCreate">Start with YouTube</button><button class="dc-btn secondary" id="dcHeroTour">Guided demo</button><button class="dc-btn secondary" data-dc-nav="review">Open Clip Review</button></div></div><div class="dc-v3-phone-wall" aria-label="Recent clip thumbnails">${heroThumbs(clips)}</div></section><section class="dc-card dc-create-card v3" data-tour="create-form"><div class="dc-create-grid"><input id="dcCreateUrl" placeholder="Paste YouTube or video URL"><select id="dcCreateTemplate" data-tour="template-picker">${(d.templates||[]).map(t=>`<option value="${esc(t.id)}" ${t.id===d.selectedTemplate?.id?'selected':''}>${esc(t.name)}</option>`).join('')}</select><select id="dcCreateCount"><option>4</option><option selected>8</option><option>12</option><option>16</option></select><select id="dcCreateDuration"><option value="15,45">15–45 sec</option><option value="30,60" selected>30–60 sec</option><option value="45,90">45–90 sec</option></select><button class="dc-btn" id="dcGenerate" data-tour="generate-button">Generate clips</button></div></section><div class="dc-home-metrics v3 dc-home-metrics-tight">${metric(projects.length,'Lectures')}${metric(clips.length,'Clips')}${metric(waiting,'Clip Review')}${metric(scheduled,'Scheduled')}${metric(posted,'Posted')}</div><div class="dc-v3-action-grid"><button class="dc-v3-source" type="button" id="dcSourceYouTube"><span class="dc-v3-platform youtube">${socialSvg('youtube')}</span><strong>YouTube import</strong><span>Paste lecture link</span></button><button class="dc-v3-source" type="button" data-dc-nav="review"><span class="dc-v3-platform template">${ICON.review}</span><strong>Clip Review</strong><span>${waiting} waiting approval</span></button><button class="dc-v3-source" type="button" data-dc-nav="editor"><span class="dc-v3-platform template">${ICON.style}</span><strong>${esc(selectedTemplate)}</strong><span>Default template</span></button><button class="dc-v3-source" type="button" data-dc-nav="publishing"><span class="dc-v3-platform publish">${ICON.social}</span><strong>Connections</strong><span>TikTok, Instagram, Facebook</span></button></div><div class="dc-home-grid dc-home-grid-balanced"><div class="dc-stack"><section class="dc-card dc-card-pad v3-card dc-now-compact" data-tour="happening-now"><div class="dc-card-head"><div><h2>Happening now</h2><p>Only live work and latest result.</p></div><span class="dc-pill ${jobs.length?'warn':'good'}">${jobs.length?`${jobs.length} live`:'All clear'}</span></div><div class="dc-now-list">${jobs.length?jobs.slice(0,3).map(jobRow).join(''):latestActivity(d)}</div></section><section class="dc-card dc-card-pad v3-card"><div class="dc-card-head"><div><h2>Recent projects</h2><p>Continue working.</p></div><button class="dc-btn secondary" data-dc-nav="projects">View all</button></div><div class="dc-row-list dc-short-list">${recentProjects(projects,clips)}</div></section></div><div class="dc-stack dc-command-card"><section class="dc-card dc-card-pad v3-card" data-tour="platform-cards"><div class="dc-card-head"><div><h2>Platform connections</h2><p>Before posting.</p></div><button class="dc-btn secondary" data-dc-nav="publishing">Manage</button></div><div class="dc-social-grid">${socialCards(d)}</div></section><section class="dc-card dc-card-pad v3-card"><div class="dc-card-head"><div><h2>Upcoming posts</h2><p>${scheduled} ready.</p></div><button class="dc-btn secondary" data-dc-nav="schedule">Open publish</button></div><div class="dc-row-list dc-short-list">${upcomingRows(clips)}</div></section><section class="dc-card dc-card-pad v3-card"><div class="dc-card-head"><div><h2>Needs attention</h2><p>Problems only.</p></div></div><div class="dc-row-list dc-short-list">${attentionRows(d)}</div></section></div></div>`;
  $('#dcGenerate').onclick = generateProject;
  $('#dcHeroCreate').onclick = () => $('#dcCreateUrl')?.focus();
  $('#dcSourceYouTube').onclick = () => $('#dcCreateUrl')?.focus();
...
function jobRow(j){ return `<div class="dc-now-row"><span class="dc-spinner"></span><div class="dc-now-main"><strong>${esc(j.title)}</strong><span>${esc(j.stage)}</span>${Number.isFinite(j.progress)?`<div class="dc-progress"><i style="width:${clamp(j.progress,0,100)}%"></i></div>`:''}</div><span class="dc-pill warn">${Number.isFinite(j.progress)?`${Math.round(j.progress)}%`:'Live'}</span></div>`; }
function latestActivity(d){
  const logs = (d.log || []).slice(0,2);
  if (!logs.length) return `<div class="dc-empty"><strong>Nothing is processing</strong>New generations, edits and uploads will appear here.</div>`;
  return logs.map(item=>`<div class="dc-list-row"><div class="dc-social-logo">✓</div><div class="dc-list-copy"><strong>${esc(shortText(typeof item==='string'?item:item.message||item.text||'Activity',82))}</strong><span>${item.at?formatRelative(item.at):'Latest activity'}</span></div></div>`).join('');
}
function recentProjects(projects, clips){
  const list = [...projects].sort((a,b)=>Number(b.submittedAt||0)-Number(a.submittedAt||0)).slice(0,5);
  if (!list.length) return `<div class="dc-empty"><strong>No projects yet</strong>Generate clips from a lecture above.</div>`;
  return list.map(p=>{const own=clips.filter(c=>c.projectId===p.id);const thumb=own[0]?.thumbUrl;return `<button class="dc-list-row" data-open-project="${esc(p.id)}" type="button">${thumb?`<img class="dc-thumb" src="${authedUrl(thumb)}">`:'<div class="dc-thumb"></div>'}<div class="dc-list-copy"><strong>${esc(p.title||'Untitled lecture')}</strong><span>${own.length} clips · ${esc(p.stage||p.status)}</span></div><span class="dc-svg">${ICON.chevron}</span></button>`}).join('');
}
function socialCards(d){
  const providers=d.social?.providers||{}, names={youtube:'YouTube',instagram:'Instagram',facebook:'Facebook',tiktok:'TikTok'};
  return Object.entries(names).map(([key,name])=>{const p=providers[key]||{}, account=p.accounts?.[0]?.name; return `<div class="dc-social-card v3"><div class="dc-social-top"><div class="dc-social-logo ${key}">${socialSvg(key)}</div><div class="dc-social-copy"><strong>${name}</strong><span>${p.connected?esc(account||'Connected'):p.configured?'Ready to connect':'Setup required'}</span></div><span class="dc-pill ${p.connected?'good':p.configured?'warn':'bad'}">${p.connected?'Connected':p.configured?'Connect':'Missing'}</span></div><button class="dc-btn ${p.connected?'secondary':''}" data-dc-nav="publishing" ${!p.configured?'disabled':''}>${p.connected?'Settings':'Connect'}</button></div>`}).join('');
}
function attentionRows(d){
  const items=[];
  if(!d.readiness?.templateReady) items.push(['Choose an editing style','Open Editor and select a style','editor']);
  if(!d.readiness?.musicReady) items.push(['Music is missing','Upload a nasheed before rendering','music']);
  (d.projects||[]).filter(p=>p.status==='failed').slice(0,3).forEach(p=>items.push([p.title||'Project failed',p.error||p.stage||'Processing failed','projects']));
  (d.clips||[]).filter(c=>c.status==='publish_failed').slice(0,3).forEach(c=>items.push([c.title||'Publishing failed',(c.targets||[]).find(t=>t.error)?.error||'Open publishing status','schedule']));
  if(!items.length) return `<div class="dc-empty"><strong>Everything looks healthy</strong>No blocking issue needs your attention.</div>`;
  return items.map(i=>`<button class="dc-list-row" data-dc-nav="${i[2]}" type="button"><div class="dc-social-logo">!</div><div class="dc-list-copy"><strong>${esc(i[0])}</strong><span>${esc(i[1])}</span></div><span class="dc-svg">${ICON.chevron}</span></button>`).join('');
}
function upcomingRows(clips){
  const list=clips.filter(c=>Number(c.scheduledAt)>Date.now()&&!['posted','ready'].includes(c.status)).sort((a,b)=>a.scheduledAt-b.scheduledAt).slice(0,4);
  if(!list.length) return `<div class="dc-empty"><strong>No clips scheduled</strong>Review clips, then schedule them for publishing.</div>`;
  return list.map(c=>`<div class="dc-list-row"><img class="dc-thumb" src="${authedUrl(c.thumbUrl)}"><div class="dc-list-copy"><strong>${esc(c.title)}</strong><span>${formatDate(c.scheduledAt)} · ${(c.targets||[]).map(t=>t.provider).join(', ')||'Local export'}</span></div></div>`).join('');
}

function shortText(value,max=80){const text=String(value??'').replace(/\s+/g,' ').trim();return text.length>max?`${text.slice(0,max-1)}…`:text}
function shortError(value){const text=String(value||'Processing failed');if(/not a bot|cookies|Sign in/i.test(text))return 'YouTube blocked this download. Upload fresh cookies, then retry.';return shortText(text,120)}
function projectDisplayTitle(p){const title=String(p.title||'').trim();if(title && !/^https?:\/\//i.test(title))return title;try{const url=new URL(p.url||title);return url.hostname.replace(/^www\./,'')+' lecture'}catch{return title||'Untitled lecture'}}
function renderInsights(){
  const panel=$('#view-insights'),d=data();if(!panel||!d)return;
  const clips=d.clips||[], posted=clips.filter(c=>c.status==='posted'), scheduled=clips.filter(c=>['approved','scheduled','publishing'].includes(c.status)), failed=clips.filter(c=>c.status==='publish_failed');
  const avgScore=clips.length?Math.round(clips.reduce((a,c)=>a+Number(c.score||0),0)/clips.length):0;
  const top=[...clips].sort((a,b)=>Number(b.score||0)-Number(a.score||0)).slice(0,5);
  panel.innerHTML=`<div class="dc-page-head"><div><h1>Analytics</h1><p>Simple performance and workflow overview.</p></div><span class="dc-pill">Beta</span></div><div class="dc-analytics-hero"><div class="dc-analytics-stat"><strong>${clips.length}</strong><span>Total clips</span></div><div class="dc-analytics-stat"><strong>${avgScore}</strong><span>Average AI score</span></div><div class="dc-analytics-stat"><strong>${posted.length}</strong><span>Posted</span></div><div class="dc-analytics-stat"><strong>${scheduled.length}</strong><span>Scheduled</span></div><div class="dc-analytics-stat ${failed.length?'bad':''}"><strong>${failed.length}</strong><span>Failed posts</span></div></div><div class="dc-home-grid"><section class="dc-card dc-card-pad v3-card"><div class="dc-card-head"><div><h2>Top clips</h2><p>Highest scoring moments.</p></div></div><div class="dc-row-list">${top.length?top.map(c=>`<button class="dc-list-row" data-edit-style-clip="${esc(c.id)}"><img class="dc-thumb" src="${authedUrl(c.thumbUrl)}"><div class="dc-list-copy"><strong>${esc(shortText(c.title,72))}</strong><span>Score ${Math.round(c.score||0)} · ${statusName(c.status)}</span></div><span class="dc-pill good">${Math.round(c.score||0)}</span></button>`).join(''):'<div class="dc-empty"><strong>No clips yet</strong>Generate a project first.</div>'}</div></section><section class="dc-card dc-card-pad v3-card"><div class="dc-card-head"><div><h2>Posting funnel</h2><p>Where clips are sitting.</p></div></div><div class="dc-funnel"><div><b>${clips.filter(c=>c.status==='waiting').length}</b><span>Review</span></div><div><b>${scheduled.length}</b><span>Scheduled</span></div><div><b>${posted.length}</b><span>Posted</span></div><div><b>${failed.length}</b><span>Failed</span></div></div></section></div>`;
}
function renderConnections(){
  const panel=$('#view-publishing'),d=data();if(!panel||!d)return;
  const providers=d.social?.providers||{};
  panel.innerHTML=`<div class="dc-page-head"><div><h1>Connections</h1><p>Connect accounts, test access and keep posting safe.</p></div><button class="dc-btn secondary" data-dc-nav="schedule">Open publish queue</button></div><div class="dc-connection-grid">${['youtube','tiktok','instagram','facebook'].map(key=>connectionCard(key,providers[key]||{})).join('')}</div><div class="dc-home-grid"><section class="dc-card dc-card-pad v3-card"><div class="dc-card-head"><div><h2>Posting readiness</h2><p>What must be ready before scheduling.</p></div></div><div class="dc-row-list">${attentionRows(d)}</div></section><section class="dc-card dc-card-pad v3-card"><div class="dc-card-head"><div><h2>YouTube downloader cookies</h2><p>Required when YouTube blocks Render as a bot.</p></div></div><div class="dc-empty"><strong>Cookie upload remains in the original publishing tools</strong>Use your current cookie uploader if YouTube import gets blocked.</div></section></div>`;
}
function connectionCard(key,p){const name={youtube:'YouTube',tiktok:'TikTok',instagram:'Instagram',facebook:'Facebook'}[key]||key,oauth=(key==='instagram'||key==='facebook')?'meta':key,account=p.accounts?.[0]?.name||'';return `<article class="dc-connection-card ${key}"><div class="dc-connection-top"><div class="dc-connection-logo ${key}">${socialSvg(key)}</div><div><strong>${name}</strong><span>${p.connected?esc(account||'Connected'):p.configured?'Ready to connect':'Missing setup'}</span></div><span class="dc-pill ${p.connected?'good':p.configured?'warn':'bad'}">${p.connected?'Connected':p.configured?'Ready':'Missing'}</span></div><div class="dc-connection-actions">${p.connected?`<button class="dc-btn secondary" data-social-test="${key}">Test</button><button class="dc-btn danger" data-social-disconnect="${oauth}">Disconnect</button>`:`<button class="dc-btn" data-social-connect="${oauth}" ${!p.configured?'disabled':''}>Connect</button>`}</div>${p.lastTestError?`<div class="dc-project-error"><span>${esc(shortError(p.lastTestError))}</span></div>`:''}</article>`}
function renderMusicLibrary(){
  const panel=$('#view-music'),d=data();if(!panel||!d)return;
  const tracks=d.tracks||[], settings=d.musicSettings||{};
  panel.innerHTML=`<div class="dc-page-head"><div><h1>Audio library</h1><p>Nasheeds and background mixing for rendered clips.</p></div><button class="dc-btn secondary" data-dc-nav="editor">Open editor audio</button></div><div class="dc-audio-hero"><div><strong>${tracks.length}</strong><span>Tracks ready</span></div><div><strong>${settings.volumePercent??13}%</strong><span>Music volume</span></div><div><strong>${settings.required===false?'Optional':'Required'}</strong><span>Render rule</span></div></div><div class="dc-home-grid"><section class="dc-card dc-card-pad v3-card"><div class="dc-card-head"><div><h2>Library</h2><p>Delete tracks you do not want rotated into clips.</p></div></div><div class="dc-row-list">${tracks.length?tracks.map(t=>`<div class="dc-list-row"><div class="dc-social-logo">♫</div><div class="dc-list-copy"><strong>${esc(t.name||t.id)}</strong><span>${esc(t.duration?formatDuration(t.duration*1000):t.file||'Audio track')}</span></div><button class="dc-btn danger" data-delete-track="${esc(t.id||t.name)}">Delete</button></div>`).join(''):'<div class="dc-empty"><strong>No music uploaded</strong>Add tracks using the original uploader if needed.</div>'}</div></section><section class="dc-card dc-card-pad v3-card"><div class="dc-card-head"><div><h2>Mix settings</h2><p>Simple global audio controls.</p></div></div><div class="dc-field"><label><span>Background volume</span><b id="dcV3MusicVolLabel">${settings.volumePercent??13}%</b></label><input type="range" id="dcV3MusicVolume" min="1" max="50" value="${settings.volumePercent??13}"></div><button class="dc-btn" id="dcV3SaveMusic">Save audio settings</button></section></div>`;
  $('#dcV3MusicVolume')?.addEventListener('input',e=>$('#dcV3MusicVolLabel').textContent=`${e.target.value}%`);
}
function renderSettings(){
  const panel=$('#view-automation'),d=data();if(!panel||!d)return;
  const a=d.automationSettings||{}, p=d.publishingSettings||{};
  panel.innerHTML=`<div class="dc-page-head"><div><h1>Settings</h1><p>Real app rules for generation, posting and safety.</p></div><button class="dc-btn" id="dcV3SaveSettings">Save settings</button></div><div class="dc-settings-grid"><section class="dc-card dc-card-pad v3-card"><div class="dc-card-head"><div><h2>Clip generation</h2><p>Control automation quality.</p></div></div><label class="dc-check"><input id="dcSetAutoEnabled" type="checkbox" ${a.enabled?'checked':''}>Enable automatic clip approval</label><div class="dc-field"><label><span>Minimum AI score</span><b id="dcSetScoreLabel">${a.minimumScore??85}</b></label><input id="dcSetScore" type="range" min="50" max="100" value="${a.minimumScore??85}"></div><div class="dc-field"><label><span>Maximum clips per lecture</span><b id="dcSetMaxLabel">${a.maxPerProject??8}</b></label><input id="dcSetMax" type="range" min="1" max="20" value="${a.maxPerProject??8}"></div></section><section class="dc-card dc-card-pad v3-card"><div class="dc-card-head"><div><h2>Posting safety</h2><p>Keep public posting deliberate.</p></div></div><label class="dc-check"><input id="dcSetPublishEnabled" type="checkbox" ${p.enabled?'checked':''}>Enable automatic publishing</label><div class="dc-caption-note">TikTok still needs Test connection before scheduling because privacy options must be fresh.</div></section><section class="dc-card dc-card-pad v3-card"><div class="dc-card-head"><div><h2>Storage and cleanup</h2><p>Prepare for public launch later.</p></div></div><div class="dc-empty"><strong>Coming next</strong>Data retention, user accounts, billing limits and storage cleanup will belong here.</div></section></div>`;
  $('#dcSetScore')?.addEventListener('input',e=>$('#dcSetScoreLabel').textContent=e.target.value);
  $('#dcSetMax')?.addEventListener('input',e=>$('#dcSetMaxLabel').textContent=e.target.value);
}
async function deleteMusicTrack(id){if(!confirm('Delete this audio track?'))return;try{await callApi(`/api/music/${encodeURIComponent(id)}`,{method:'DELETE'});notify('Track deleted');await refreshData();renderMusicLibrary()}catch(e){notify(e.message,'bad')}}
async function saveMusicSettingsV3(){try{await callApi('/api/music-settings',{method:'POST',body:JSON.stringify({volumePercent:Number($('#dcV3MusicVolume')?.value||13)})});notify('Audio settings saved');await refreshData();renderMusicLibrary()}catch(e){notify(e.message,'bad')}}
async function saveAutomationSettingsV3(){try{await callApi('/api/automation-settings',{method:'POST',body:JSON.stringify({enabled:Boolean($('#dcSetAutoEnabled')?.checked),minimumScore:Number($('#dcSetScore')?.value||85),minimumQuality:Number(data()?.automationSettings?.minimumQuality||85),maxPerProject:Number($('#dcSetMax')?.value||8)})});await callApi('/api/publishing-settings',{method:'POST',body:JSON.stringify({...data()?.publishingSettings,enabled:Boolean($('#dcSetPublishEnabled')?.checked)})});notify('Settings saved');await refreshData();renderSettings()}catch(e){notify(e.message,'bad')}}
...
function renderProjects(){
  ...
  panel.classList.toggle('dc-project-detail-view', Boolean(selectedProjectId));
...
function projectCard(p,clips){
  const own=clips.filter(c=>c.projectId===p.id),thumb=own[0]?.thumbUrl,waiting=own.filter(c=>c.status==='waiting').length,posted=own.filter(c=>c.status==='posted').length,scheduled=own.filter(c=>['approved','scheduled','publishing'].includes(c.status)).length;
  const failed=p.status==='failed', processing=['queued','processing'].includes(p.status);
  const title=projectDisplayTitle(p);
  return `<article class="dc-project-card v3-project"><button class="dc-project-cover" data-open-project="${esc(p.id)}" type="button">${thumb?`<img src="${authedUrl(thumb)}">`:`<div class="dc-project-placeholder">${ICON.projects}<span>Lecture</span></div>`}<span class="dc-project-status dc-pill ${failed?'bad':processing?'warn':'good'}">${esc(statusName(p.status))}</span><button class="dc-icon-btn dc-project-delete" type="button" data-delete-project="${esc(p.id)}" title="Delete project">×</button></button><div class="dc-project-body"><h3>${esc(title)}</h3><p>${failed?esc(shortError(p.error||p.stage)):esc(p.stage||p.status)}</p><div class="dc-project-stats"><div class="dc-project-stat"><strong>${own.length}</strong><span>clips</span></div><div class="dc-project-stat"><strong>${waiting}</strong><span>review</span></div><div class="dc-project-stat"><strong>${scheduled}</strong><span>scheduled</span></div><div class="dc-project-stat"><strong>${posted}</strong><span>posted</span></div></div><div class="dc-project-actions"><button class="dc-btn" data-open-project="${esc(p.id)}">Open</button>${failed?`<button class="dc-btn secondary" data-retry-project="${esc(p.id)}">Retry</button>`:`<button class="dc-btn secondary" data-more-project="${esc(p.id)}" ${!p.sourceReusable?'disabled':''}>More clips</button>`}<button class="dc-btn danger" data-delete-project="${esc(p.id)}">Delete</button></div></div></article>`;
}
...
function renderProjectDetail(panel,d){
  ...
  panel.innerHTML=`<div class="dc-project-detail-v3"><div class="dc-project-detail-hero"><button class="dc-icon-btn dc-svg" id="dcBackProjects">${ICON.back}</button><div class="dc-project-detail-copy"><h1>${esc(projectDisplayTitle(p))}</h1><p>${clips.length} clips · ${waiting} review · ${scheduled} scheduled · ${posted} posted</p></div><span class="dc-pill ${p.status==='failed'?'bad':['queued','processing'].includes(p.status)?'warn':'good'}">${esc(statusName(p.status))}</span><button class="dc-btn secondary" data-more-project="${esc(p.id)}" ${!p.sourceReusable?'disabled':''}>More clips</button><button class="dc-btn danger" data-delete-project="${esc(p.id)}">Delete</button></div>${p.status==='failed'||p.error?`<div class="dc-project-error"><strong>Processing issue</strong><span>${esc(shortError(p.error||p.stage))}</span><button class="dc-btn secondary" data-retry-project="${esc(p.id)}">Retry</button></div>`:''}${p.moreJob&&['queued','processing'].includes(p.moreJob.status)?`<div class="dc-card dc-card-pad" style="margin-bottom:12px"><div class="dc-now-row"><span class="dc-spinner"></span><div class="dc-now-main"><strong>${esc(p.moreJob.stage||'Generating more clips')}</strong><span>Reusing saved lecture and transcript.</span><div class="dc-progress"><i style="width:${clamp(p.moreJob.progress,0,100)}%"></i></div></div><span class="dc-pill warn">${Math.round(p.moreJob.progress||0)}%</span></div></div>`:''}<div class="dc-project-detail-toolbar"><strong>Clips</strong><span class="dc-pill">${clips.length}</span><span class="spacer"></span><button class="dc-btn secondary" data-dc-nav="review">Open Clip Review</button></div><div class="dc-clip-grid dc-project-clip-grid">${clips.length?clips.map(c=>clipCard(c,{detail:true})).join(''):`<div class="dc-empty"><strong>No clips yet</strong>${['queued','processing'].includes(p.status)?'Processing is still underway.':'Generate more clips from this lecture.'}</div>`}</div></div>`;
  $('#dcBackProjects').onclick=()=>{selectedProjectId='';renderProjects()};
}

function clipCard(c,opts={}){
  const nextAction=c.status==='waiting'
    ?`<button class="dc-btn secondary" data-schedule-clip="${esc(c.id)}">Schedule</button>`
    :['approved','ready','publish_failed','scheduled'].includes(c.status)
      ?`<button class="dc-btn secondary" data-post-clip="${esc(c.id)}">Post now</button>`:'';
  const title=shortText(c.title||'Untitled clip', opts.detail?60:44);
  return `<article class="dc-clip-card v3-clip-card"><button class="dc-clip-media" data-edit-style-clip="${esc(c.id)}" type="button">${c.thumbUrl?`<img src="${authedUrl(c.thumbUrl)}">`:`<div class="dc-project-placeholder">${ICON.play}<span>Clip</span></div>`}<span class="dc-score">${Math.round(c.score||0)}</span><span class="dc-duration">${formatDuration(c.durationMs)}</span><span class="dc-clip-state dc-pill ${c.status==='posted'?'good':c.status==='waiting'?'warn':c.status==='publish_failed'?'bad':''}">${statusName(c.status)}</span></button><div class="dc-clip-body"><h3>${esc(title)}</h3><p>${c.scheduledAt?formatDate(c.scheduledAt):statusName(c.status)}</p><div class="dc-clip-actions"><button class="dc-btn" data-edit-style-clip="${esc(c.id)}">Edit style</button><button class="dc-btn secondary" data-edit-video-clip="${esc(c.id)}">Edit video</button>${nextAction||`<button class="dc-btn secondary" data-download-clip="${esc(c.id)}">Download</button>`}<button class="dc-btn danger" data-delete-clip="${esc(c.id)}">Delete</button></div></div></article>`;
}
...
function renderReview(){
  ...
  panel.innerHTML=`<div class="dc-page-head"><div><h1>Clip Review</h1><p>Approve, edit, schedule or reject AI-selected clips.</p></div><div class="dc-review-toolbar"><span class="dc-pill ${waiting.length?'warn':'good'}">${waiting.length} waiting</span><button class="dc-btn secondary" id="dcApproveVerified" ${!waiting.length?'disabled':''}>Approve verified</button><button class="dc-btn" id="dcScheduleAll" ${!waiting.length?'disabled':''}>Schedule all</button></div></div><div class="dc-review-queue">${waiting.length?waiting.map(reviewRow).join(''):`<div class="dc-empty"><strong>Review queue is clear</strong>New generated clips will appear here.</div>`}</div>`;
  $('#dcApproveVerified').onclick=approveVerified;
  $('#dcScheduleAll').onclick=()=>scheduleMany(waiting.map(c=>c.id));
}
function reviewRow(c){
  return `<article class="dc-review-row"><button class="dc-review-thumb" data-edit-style-clip="${esc(c.id)}" type="button">${c.thumbUrl?`<img src="${authedUrl(c.thumbUrl)}">`:`${ICON.play}`}<span>${Math.round(c.score||0)}</span></button><div class="dc-review-main"><strong>${esc(shortText(c.title||'Untitled clip',86))}</strong><small>${formatDuration(c.durationMs)} · ${c.musicVerified&&c.renderVerified?'Verified render':'Needs checking'}</small></div><div class="dc-review-actions"><button class="dc-btn" data-approve-clip="${esc(c.id)}">Approve</button><button class="dc-btn secondary" data-edit-style-clip="${esc(c.id)}">Edit style</button><button class="dc-btn secondary" data-edit-video-clip="${esc(c.id)}">Edit video</button><button class="dc-btn secondary" data-schedule-clip="${esc(c.id)}">Schedule</button><button class="dc-btn danger" data-delete-clip="${esc(c.id)}">Reject</button></div></article>`;
}
...
async function approveClip(id){try{await callApi(`/api/clips/${encodeURIComponent(id)}`,{method:'PATCH',body:JSON.stringify({status:'approved'})});notify('Clip approved');await refreshData();renderCurrent()}catch(e){notify(e.message,'bad')}}
...
function openEditor(id){ selectedClipId=id; editor.clipId=''; go('editor'); }
async function ensureEditor(){
  ...
  if(editor.clipId!==clip.id){
    editor.loading=true; editor.clipId=clip.id; editor.tool='captions';editor.captionTab='styles';editor.search='';
...
function bindCanvasDrag(){
  ...
  const ensureManual=()=>{if(editor.draft?.fitMode!=='crop')return false;switchToManualFraming('Manual crop selected by dragging the video');return true};
...
function updatePlayhead(time){const duration=editor.trimOut||1,scroll=$('#dcTimelineScroll'),width=editor.timelineWidth||scroll?.clientWidth||0;const left=56+(time/duration)*Math.max(1,width-56);const head=$('#dcPlayhead');if(head)head.style.left=`${left}px`;applyFrameAtTime(time);$$('.dc-caption-block').forEach(b=>b.classList.toggle('active',time>=Number(b.dataset.captionStart)&&time<Number(b.dataset.captionEnd)))}
...
function updateEditorPreview(){
  ...
  canvas.style.aspectRatio=`${d.width||1080}/${d.height||1920}`;canvas.dataset.fill=d.fitMode||'contain';canvas.dataset.framing=d.fitMode==='crop'&&d.smartFramingEnabled?editor.framingStatus:'off';canvas.classList.toggle('is-manual-crop',d.fitMode==='crop'&&!d.smartFramingEnabled);canvas.style.setProperty('--dc-canvas-background',d.frameBackground||'#000000');const badge=$('#dcLayerBadge');if(badge)badge.textContent=d.fitMode==='contain'?'Fit · full source':d.fitMode==='blur'?'Blur · full source':'Fill · cropped source';
  ...
  overlay.className=`dc-caption-overlay align-${d.captionHorizontal||'center'}`;overlay.style.left=`${clamp(Number(d.captionPositionX??50),7,93)}%`;overlay.style.top=`${clamp(Number(d.captionPositionY??58),8,88)}%`;
...
function renderTimeline(){
  const video=$('#dcEditorVideo'),duration=video?.duration||editor.trimOut||1,ruler=$('#dcRuler'),track=$('#dcCaptionTrack'),scroll=$('#dcTimelineScroll');if(!ruler||!track)return;
  editor.timelineWidth=Math.max(scroll?.clientWidth||0,56+Math.ceil(duration*42));
  ...
  track.innerHTML=segments.map(s=>{const left=100*s.start/duration,width=Math.max(1.8,100*(s.end-s.start)/duration);return `<button class="dc-caption-block" title="${esc(s.text)}" data-caption-start="${s.start}" data-caption-end="${s.end}" style="left:${left}%;width:${width}%">${esc(s.text)}</button>`}).join('');
...
function renderSidebarLive(){
  ...
  const body=jobs.length?jobs.slice(0,2).map(j=>`<div class="dc-mini-job"><span class="dc-mini-job-icon">${j.kind==='publish'?ICON.publish:j.kind==='render'?ICON.editor:ICON.scissors}</span><div><strong>${esc(j.title)}</strong><span>${esc(j.stage)}${Number.isFinite(j.progress)?` · ${Math.round(j.progress)}%`:''}</span></div></div>`).join(''):`<div class="dc-mini-job"><span class="dc-mini-job-icon">${ICON.check||ICON.home}</span><div><strong>${waiting?`${waiting} waiting review`:'All clear'}</strong><span>${next?`Next ${formatDate(next.scheduledAt)}`:'No active job'}</span></div></div>`;
  box.innerHTML=`<div class="dc-sidebar-live-head"><div><strong>Happening now</strong><br><span>${jobs.length?'Live activity':'Workflow status'}</span></div><i class="dc-live-orb ${jobs.length?'busy':''}"></i></div>${body}<div class="dc-sidebar-live-foot"><button class="dc-btn secondary" data-dc-nav="review">Review</button><button class="dc-btn secondary" data-dc-nav="schedule">Publish</button></div>`;
}
