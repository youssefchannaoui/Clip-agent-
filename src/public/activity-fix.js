...
/* Phase 2A — clarity, overflow and navigation stabilisation.
   Keeps the sidebar, removes the duplicate fake Editor destination, and makes
   the existing working pages fit inside the new shell without clipping. */
(() => {
  'use strict';
  const $ = (selector, root=document) => root.querySelector(selector);
  const $$ = (selector, root=document) => [...root.querySelectorAll(selector)];
  ...
  function installStyles(){
    if($('#dcPhase2AStyles')) return;
    const style=document.createElement('style');
    style.id='dcPhase2AStyles';
    style.textContent=`
      body.dc-workspace,body.dc-workspace #app,body.dc-workspace #app>.wrap,
      body.dc-workspace .shell,body.dc-workspace .main-col,body.dc-workspace .panel,
      body.dc-workspace .slab,body.dc-workspace .clip,body.dc-workspace .clip-main,
      body.dc-workspace .clip-content,body.dc-workspace .library-controls,
      body.dc-workspace .template-shell,body.dc-workspace .analytics-grid,
      body.dc-workspace .music-grid,body.dc-workspace .platform-grid{min-width:0!important}

      body.dc-workspace #app>.wrap{overflow:visible!important}
      body.dc-workspace .shell{width:100%!important;max-width:none!important}
      body.dc-workspace .main-col{overflow:visible!important}
      body.dc-workspace .panel{width:100%!important;max-width:1440px!important;overflow:visible!important}
      body.dc-workspace .panel>.head:first-child{margin-top:0!important}
      body.dc-workspace .head,body.dc-workspace .sched-head{gap:12px!important;flex-wrap:wrap!important}
      body.dc-workspace .head>div,body.dc-workspace .sched-head>div{min-width:0!important}
      body.dc-workspace h2{overflow-wrap:anywhere}
      body.dc-workspace input,body.dc-workspace textarea,body.dc-workspace select{max-width:100%!important;min-width:0!important}
      body.dc-workspace textarea{resize:vertical}
      body.dc-workspace .intake-row,body.dc-workspace .template-actions,
      body.dc-workspace .music-upload-row,body.dc-workspace .library-browser-tools,
      body.dc-workspace .library-browser-foot{flex-wrap:wrap!important}

      body.dc-workspace .library-controls{
        display:grid!important;
        grid-template-columns:minmax(240px,1fr) auto minmax(160px,220px)!important;
        align-items:center!important;
        gap:10px!important;
      }
      body.dc-workspace .library-filter{display:flex!important;flex-wrap:wrap!important;gap:7px!important}
      body.dc-workspace .library-search,body.dc-workspace .library-select{width:100%!important}
      body.dc-workspace .library-hero,body.dc-workspace .figs{
        display:grid!important;grid-template-columns:repeat(auto-fit,minmax(170px,1fr))!important;gap:10px!important
      }
      body.dc-workspace .library-list,body.dc-workspace #libraryList{min-width:0!important}
      body.dc-workspace .library-row,body.dc-workspace .library-card{min-width:0!important;overflow:hidden!important}

      body.dc-workspace .analytics-grid,body.dc-workspace .music-grid,body.dc-workspace .platform-grid{
        display:grid!important;
        grid-template-columns:repeat(auto-fit,minmax(300px,1fr))!important;
        gap:14px!important;
      }
      body.dc-workspace .analytics-hero,body.dc-workspace .social-analytics{
        display:grid!important;grid-template-columns:repeat(auto-fit,minmax(300px,1fr))!important;gap:14px!important
      }
      body.dc-workspace .template-shell{
        display:grid!important;grid-template-columns:minmax(300px,420px) minmax(0,1fr)!important;gap:18px!important;align-items:start!important
      }
      body.dc-workspace .template-preview-wrap{min-width:0!important}
      body.dc-workspace .template-preview-wrap>.slab{position:sticky;top:calc(var(--dc-topbar-h) + 18px)}
      body.dc-workspace .editor-stack{min-width:0!important}
      body.dc-workspace .editor-grid{grid-template-columns:repeat(auto-fit,minmax(220px,1fr))!important}

      body.dc-workspace .clip{overflow:hidden!important}
      body.dc-workspace .clip-main{display:grid!important;grid-template-columns:180px minmax(0,1fr)!important;gap:15px!important}
      body.dc-workspace .clip-thumb{width:180px!important;max-width:100%!important}
      body.dc-workspace .clip-content{overflow:hidden!important}
      body.dc-workspace .clip-title,body.dc-workspace .clip-body,body.dc-workspace .clip-tags{width:100%!important;box-sizing:border-box!important}
      body.dc-workspace .clip-top,body.dc-workspace .clip-actions,body.dc-workspace .destinations{display:flex!important;flex-wrap:wrap!important;gap:7px!important}
      body.dc-workspace .clip-meta{white-space:normal!important;overflow-wrap:anywhere!important}
      body.dc-workspace .board,body.dc-workspace .schedule-board{overflow-x:auto!important;padding-bottom:8px!important}

      body.dc-workspace .library-browser{
        left:var(--dc-sidebar-w)!important;right:0!important;top:var(--dc-topbar-h)!important;bottom:0!important;
        width:auto!important;height:auto!important;max-width:none!important;z-index:205!important
      }
      body.dc-workspace.dc-sidebar-collapsed .library-browser{left:var(--dc-sidebar-collapsed)!important}
      body.dc-workspace .library-browser-head{display:grid!important;grid-template-columns:auto minmax(180px,1fr)!important;gap:10px!important;align-items:center!important}
      body.dc-workspace .library-browser-title{min-width:0!important}
      body.dc-workspace .library-browser-title strong,body.dc-workspace .library-browser-title span{overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important}
      body.dc-workspace .library-browser-tools{grid-column:1/-1;display:grid!important;grid-template-columns:minmax(200px,1fr) repeat(3,minmax(120px,auto)) auto!important;gap:8px!important}
      body.dc-workspace .library-browser-body{min-height:0!important;overflow:auto!important}
      body.dc-workspace .library-clip-grid{display:grid!important;grid-template-columns:repeat(auto-fill,minmax(280px,1fr))!important;gap:13px!important}
      body.dc-workspace .library-browser-foot{position:sticky!important;bottom:0!important;z-index:2!important;background:#101012!important}

      body.dc-workspace .video-modal{z-index:270!important;padding:18px!important;overflow:auto!important}
      body.dc-workspace .video-modal-card{max-width:min(980px,100%)!important;max-height:calc(100vh - 36px)!important;overflow:auto!important}
      body.dc-workspace .video-modal video{max-width:100%!important;max-height:calc(100vh - 130px)!important}
      body.dc-workspace .card-lock{max-width:min(520px,calc(100vw - 32px))!important}

      .dc-page-jumps{display:flex;align-items:center;gap:7px;flex-wrap:wrap;margin:0 0 18px;padding:7px;background:var(--dc-panel);border:1px solid var(--dc-line);border-radius:9px}
      .dc-page-jumps button{min-height:34px;padding:0 11px;border-radius:7px;color:var(--dc-muted);font-size:12px}
      .dc-page-jumps button:hover{background:var(--dc-panel-2);color:var(--dc-text)}
      .dc-page-jumps strong{padding:0 7px;color:var(--dc-text);font-size:12px}
      .dc-page-help{margin-left:auto;color:var(--dc-subtle);font-size:11.5px;padding:0 7px}

      @media(max-width:1080px){
        body.dc-workspace .library-controls{grid-template-columns:1fr!important}
        body.dc-workspace .template-shell{grid-template-columns:1fr!important}
        body.dc-workspace .template-preview-wrap>.slab{position:relative;top:auto}
        body.dc-workspace .library-browser-tools{grid-template-columns:1fr 1fr!important}
      }
      @media(max-width:820px){
        body.dc-workspace .library-browser,body.dc-workspace.dc-sidebar-collapsed .library-browser{left:0!important;top:var(--dc-topbar-h)!important}
        body.dc-workspace .clip-main{grid-template-columns:1fr!important}
        body.dc-workspace .clip-thumb{width:100%!important;max-height:260px!important}
        body.dc-workspace .library-browser-head{grid-template-columns:1fr!important}
        body.dc-workspace .library-browser-tools{grid-template-columns:1fr!important}
        body.dc-workspace .analytics-grid,body.dc-workspace .music-grid,body.dc-workspace .platform-grid,
        body.dc-workspace .analytics-hero,body.dc-workspace .social-analytics{grid-template-columns:1fr!important}
        .dc-page-help{width:100%;margin-left:0}
      }
    `;
    document.head.appendChild(style);
  }
  ...
  function simplifySidebar(){
    const nav=$('#dcPrimaryNav');
    if(!nav||nav.dataset.phase2a==='1') return;
    nav.dataset.phase2a='1';
    const buttons=$$('.dc-nav-btn',nav);
    if(buttons.length>=6){
      // The old "Editor" button opened the same Library page as Content Library.
      // Remove the duplicate until the real editor route exists.
      buttons[2].remove();
      const remaining=$$('.dc-nav-btn',nav);
      const labels=['Home','Projects','Publishing','Library','Analytics'];
      remaining.forEach((button,index)=>{
        const copy=$('.dc-nav-copy',button);
        if(copy&&labels[index]) copy.textContent=labels[index];
        button.title=labels[index]||button.title;
      });
    }
  }

  function addJumpBar(panelId,items,help){
    const panel=$(panelId);
    if(!panel||$('.dc-page-jumps',panel)) return;
    const bar=document.createElement('div');
    bar.className='dc-page-jumps';
    bar.innerHTML=`<strong>On this page</strong>${items.map(item=>`<button type="button" data-jump="${item.selector}">${item.label}</button>`).join('')}<span class="dc-page-help">${help}</span>`;
    panel.insertBefore(bar,panel.firstChild);
    $$('[data-jump]',bar).forEach(button=>button.addEventListener('click',()=>{
      const target=$(button.dataset.jump,panel)||$(button.dataset.jump);
      target?.scrollIntoView({behavior:'smooth',block:'start'});
    }));
  }

  function installPageGuides(){
    addJumpBar('#view-queue',[
      {label:'Import lecture',selector:'.intake'},
      {label:'Processing',selector:'#procList'},
      {label:'Ready to review',selector:'#waitList'}
    ],'Import, monitor, then review clips here.');
    addJumpBar('#view-schedule',[
      {label:'Calendar',selector:'#rail'},
      {label:'Publishing queue',selector:'#schedList'}
    ],'Scheduled and failed publishing work stays here.');
    addJumpBar('#view-library',[
      {label:'Search',selector:'.library-controls'},
      {label:'Projects',selector:'#libraryList'}
    ],'Open a lecture to see all of its generated clips.');
    addJumpBar('#view-publishing',[
      {label:'Connections',selector:'#platformGrid'},
      {label:'Activity',selector:'#publishHistory'}
    ],'Connections and publishing defaults only.');
  }

  function moveTopbarSafely(){
    const title=$('#dcPageTitle');
    const processing=$('#dcProcessingButton');
    if(processing) processing.title='Open processing and attention panel';
    if(title&&title.textContent==='Content Library') title.textContent='Library';
  }

  function observe(){
    const app=$('#app');
    if(!app||app.classList.contains('hide')||!$('#dcSidebar')) return setTimeout(observe,140);
    installStyles();
    simplifySidebar();
    installPageGuides();
    moveTopbarSafely();
